...
There is no central Aegis fingerprint server. The configuration options for a remote reputation feed exist in the code, but no request is ever made to one.
