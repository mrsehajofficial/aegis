...
Last updated: **22 September 2026** · Instance operated by **[OPERATOR LEGAL NAME]**
...
- **The instance** you are using is operated by **[OPERATOR LEGAL NAME]**, who decides whether it runs, which features are enabled, and who may use it. The authors of the software do not operate this instance and cannot access its data.
...
To the maximum extent permitted by law, the operator is not liable for indirect, incidental, special or consequential damages, loss of data, loss of goodwill or reputation, or for the consequences of moderation actions — including missed spam, wrongful bans, mutes, kicks or deletions. Where liability cannot lawfully be excluded, it is limited to **[LIABILITY CAP, e.g. the amount you paid to use the Service — usually nothing]**.
...
These terms are governed by the laws of **[JURISDICTION]**, without depriving you of the protection of mandatory rules of the country where you live. Disputes are handled by the courts of **[JURISDICTION]**, unless the law gives you a different forum.

## 13. Contact

**[OPERATOR LEGAL NAME]** — **[CONTACT EMAIL]** — or open an issue at [github.com/mrsehajofficial/aegis/issues](https://github.com/mrsehajofficial/aegis/issues).
